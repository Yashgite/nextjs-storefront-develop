  ...
  return (
    <Stack alignItems={'flex-start'}>
      <List dense>
        ...
        // inside MegaMenuItem list, just for your testing
        <ListItem sx={{ cursor: 'pointer' }} onClick={onBackDropClose}>
          <StyledLink href={`/demo-category-products?categoryCode=${categoryCode}`} passHref data-testid="categoryLink">
            Debug: My Category Page
          </StyledLink>
        </ListItem>
