...
import FF_logo from '@/public/kibo_logo.png'
...
const HeaderActionArea = (props: HeaderActionAreaProps) => {
  ...
  return (
    ...
    // {/* <CustomHeader /> */}
    // </>
    <Box sx={{ ...headerActionAreaStyles.wrapper, backgroundColor: '#c5cae9' }} data-testid="header-action-area">
      <Container
        maxWidth="xl"
        sx={{
      ...
      >
        ...
        <NoSsr>
          <Box display="flex" flex={1} justifyContent={'flex-end'} gap={4}>
             {showSearchBarInLargeHeader && (
                <Box sx={headerActionAreaStyles.searchSuggestionsWrapper} data-testid="Search-container" justifyContent={'space-evenly'}>
                  <SearchSuggestions
